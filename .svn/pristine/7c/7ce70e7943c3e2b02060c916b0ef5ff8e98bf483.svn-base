function __args() {
  ...
  if (setting.url.indexOf('https://') !== 0) {
    setting.url = 'https://service.tsing-tec.com/' + setting.url;
  }
  return setting;
}
...
function signAndLogin(code, encryptedData, iv, signature, rawData) {
  ...
  wx.request({
    url: 'https://service.tsing-tec.com/applet/api/sign',
    data: params,
    method: 'POST',
